...

Processing FileName:example_data_set.xml
         3011 function calls in 0.050 seconds

   Ordered by: standard name

   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
        1    0.000    0.000    0.050    0.050 <string>:1(<module>)
     1000    0.003    0.000    0.045    0.000 ElementTree.py:1302(XML)
        1    0.000    0.000    0.000    0.000 _bootlocale.py:11(getpreferredencoding)
        1    0.000    0.000    0.000    0.000 codecs.py:260(__init__)
        1    0.000    0.000    0.000    0.000 cp1252.py:22(decode)
        1    0.005    0.005    0.050    0.050 data_structures.py:51(ProfileParseXML)
     ...
     1000    0.042    0.000    0.042    0.000 {method 'feed' of 'xml.etree.ElementTree.XMLParser' objects}
        1    0.000    0.000    0.000    0.000 {method 'read' of '_io.TextIOWrapper' objects}



Processing FileName:example_data_set.json
   ...
   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
     ...
     1000    0.001    0.000    0.012    0.000 __init__.py:299(loads)
        ...
        1    0.000    0.000    0.000    0.000 codecs.py:260(__init__)
        1    0.000    0.000    0.000    0.000 cp1252.py:22(decode)
        1    0.001    0.001    0.013    0.013 data_structures.py:57(ProfileParseJSON)
     1000    0.001    0.000    0.012    0.000 decoder.py:332(decode)
...
Processing FileName:example_data_set.yaml
         13819015 function calls (13711015 primitive calls) in 6.504 seconds

   Ordered by: standard name

   ncalls  tottime  percall  cumtime  percall filename:lineno(function)
        1    0.000    0.000    6.504    6.504 <string>:1(<module>)
     1000    0.015    0.000    6.501    0.007 __init__.py:103(load)
        1    0.000    0.000    0.000    0.000 _bootlocale.py:11(getpreferredencoding)
    ...
    41000    0.008    0.000    0.016    0.000 abc.py:137(__instancecheck__)
        ...
        1    0.000    0.000    0.000    0.000 codecs.py:260(__init__)
13000/1000    0.084    0.000    6.045    0.006 composer.py:117(compose_mapping_node)
     1000    0.000    0.000    0.000    0.000 composer.py:13(__init__)
     1000    0.002    0.000    6.144    0.006 composer.py:29(get_single_node)
     1000    0.001    0.000    6.076    0.006 composer.py:50(compose_document)
89000/1000    0.169    0.000    6.071    0.006 composer.py:63(compose_node)
    73000    0.104    0.000    0.284    0.000 composer.py:88(compose_scalar_node)
3000/1000    0.013    0.000    5.959    0.006 composer.py:99(compose_sequence_node)
    ...
    13000    0.036    0.000    0.255    0.000 constructor.py:124(construct_mapping)
    73000    0.035    0.000    0.060    0.000 constructor.py:165(construct_scalar)
    ...
    16000    0.013    0.000    0.030    0.000 constructor.py:229(construct_yaml_int)
     ...
     1000    0.001    0.000    6.473    0.006 constructor.py:39(get_single_data)
    57000    0.014    0.000    0.061    0.000 constructor.py:393(construct_yaml_str)
...
26000/20000    0.008    0.000    0.301    0.000 constructor.py:401(construct_yaml_map)
     1000    0.007    0.000    0.328    0.000 constructor.py:46(construct_document)
    89000    0.098    0.000    0.203    0.000 constructor.py:59(construct_object)
        1    0.000    0.000    0.000    0.000 cp1252.py:22(decode)
        1    0.003    0.003    6.503    6.503 data_structures.py:63(ProfileParseYAML)
   330000    0.118    0.000    0.118    0.000 error.py:6(__init__)
    16000    0.007    0.000    0.007    0.000 events.py:22(__init__)
     1000    0.000    0.000    0.000    0.000 events.py:37(__init__)
     1000    0.001    0.000    0.001    0.000 events.py:46(__init__)
    17000    0.004    0.000    0.004    0.000 events.py:5(__init__)
     1000    0.000    0.000    0.000    0.000 events.py:55(__init__)
    73000    0.050    0.000    0.050    0.000 events.py:65(__init__)
     1000    0.002    0.000    0.012    0.000 loader.py:23(__init__)
    73000    0.028    0.000    0.028    0.000 nodes.py:27(__init__)
    16000    0.007    0.000    0.007    0.000 nodes.py:36(__init__)
    89000    0.014    0.000    0.014    0.000 parser.py:107(peek_event)
   109000    0.024    0.000    0.032    0.000 parser.py:114(get_event)
     ...
     7000    0.003    0.000    0.141    0.000 parser.py:264(parse_block_node)
    28000    0.012    0.000    0.385    0.000 parser.py:267(parse_flow_node)
    54000    0.026    0.000    0.847    0.000 parser.py:270(parse_block_node_or_indentless_sequence)
    89000    0.283    0.000    1.331    0.000 parser.py:273(parse_node)
     9000    0.014    0.000    0.491    0.000 parser.py:402(parse_indentless_sequence_entry)
     7000    0.006    0.000    0.176    0.000 parser.py:422(parse_block_mapping_first_key)
    34000    0.055    0.000    1.588    0.000 parser.py:427(parse_block_mapping_key)
    27000    0.040    0.000    1.440    0.000 parser.py:446(parse_block_mapping_value)
     6000    0.006    0.000    0.390    0.000 parser.py:537(parse_flow_mapping_first_key)
    20000    0.042    0.000    1.097    0.000 parser.py:542(parse_flow_mapping_key)
    14000    0.021    0.000    0.594    0.000 parser.py:569(parse_flow_mapping_value)
     1000    0.001    0.000    0.001    0.000 parser.py:81(__init__)
     1000    0.000    0.000    0.000    0.000 parser.py:89(dispose)
   272000    0.157    0.000    5.515    0.000 parser.py:94(check_event)
   330000    0.188    0.000    0.306    0.000 reader.py:114(get_mark)
  ...
  1758000    0.305    0.000    0.305    0.000 reader.py:87(peek)
   192000    0.102    0.000    0.118    0.000 reader.py:94(prefix)
   371000    0.480    0.000    0.508    0.000 reader.py:99(forward)
    89000    0.014    0.000    0.014    0.000 resolver.py:114(ascend_resolver)
    89000    0.096    0.000    0.142    0.000 resolver.py:143(resolve)
     1000    0.000    0.000    0.000    0.000 resolver.py:21(__init__)
    89000    0.015    0.000    0.015    0.000 resolver.py:91(descend_resolver)
   672000    0.469    0.000    4.231    0.000 scanner.py:113(check_token)
   110000    0.043    0.000    0.146    0.000 scanner.py:125(peek_token)
    73000    0.408    0.000    1.398    0.000 scanner.py:1270(scan_plain)
    73000    0.144    0.000    0.376    0.000 scanner.py:1311(scan_plain_spaces)
   197000    0.128    0.000    0.365    0.000 scanner.py:135(get_token)
   167000    0.071    0.000    0.141    0.000 scanner.py:1416(scan_line_break)
  1120000    0.563    0.000    1.052    0.000 scanner.py:145(need_more_tokens)
   141000    0.266    0.000    2.928    0.000 scanner.py:156(fetch_more_tokens)
  1007000    0.162    0.000    0.162    0.000 scanner.py:264(next_possible_simple_key)
  1148000    0.385    0.000    0.385    0.000 scanner.py:279(stale_possible_simple_keys)
    79000    0.075    0.000    0.147    0.000 scanner.py:295(save_possible_simple_key)
    62000    0.012    0.000    0.012    0.000 scanner.py:312(remove_possible_simple_key)
   142000    0.035    0.000    0.045    0.000 scanner.py:325(unwind_indent)
    33000    0.007    0.000    0.007    0.000 scanner.py:349(add_indent)
    ...
    41000    0.021    0.000    0.021    0.000 scanner.py:38(__init__)
     6000    0.002    0.000    0.035    0.000 scanner.py:427(fetch_flow_mapping_start)
     6000    0.011    0.000    0.032    0.000 scanner.py:430(fetch_flow_collection_start)
     ...
     8000    0.014    0.000    0.042    0.000 scanner.py:470(fetch_flow_entry)
     1000    0.001    0.000    0.004    0.000 scanner.py:48(__init__)
     6000    0.012    0.000    0.033    0.000 scanner.py:484(fetch_block_entry)
    41000    0.124    0.000    0.280    0.000 scanner.py:545(fetch_value)
    73000    0.078    0.000    1.636    0.000 scanner.py:668(fetch_plain)
    ...
    41000    0.013    0.000    0.017    0.000 scanner.py:721(check_value)
    73000    0.024    0.000    0.036    0.000 scanner.py:731(check_plain)
   141000    0.170    0.000    0.412    0.000 scanner.py:752(scan_to_next_token)
   123000    0.030    0.000    0.030    0.000 tokens.py:3(__init__)
     1000    0.000    0.000    0.000    0.000 tokens.py:33(__init__)
    73000    0.036    0.000    0.036    0.000 tokens.py:98(__init__)
  ...
  1420000    0.138    0.000    0.154    0.000 {built-in method builtins.isinstance}
   658000    0.050    0.000    0.050    0.000 {built-in method builtins.len}
   ...
   146000    0.016    0.000    0.016    0.000 {method 'get' of 'dict' objects}
